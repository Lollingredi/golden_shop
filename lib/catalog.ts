...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    image: img("sushi-collection-hero.jpg", "Le mani di un itamae che formano un nigiri sul banco", 922, 1152),
  },
];
...
const raw = [
  ...
  makeProduct({
    ...
    price: "4800",
    maxPrice: "7200",
    image: img("wedding-corteo-supercar.jpg", "Cinque vetture sportive in fila su una strada di campagna alberata", 922, 1152),
    citta: "Su richiesta",
  ...
  makeProduct({
    ...
    price: "6500",
    maxPrice: "14000",
    image: img("location-dimora-storica.jpg", "Il piazzale in ghiaia di una villa veneta al tramonto, tavoli apparecchiati sotto il colonnato", 922, 1152),
  ...
  makeProduct({
    ...
    price: "2900",
    maxPrice: "4200",
    image: img("wedding-celebrity-experience-sposi.jpg", "Sposi di spalle verso l'auto ancora coperta, tra due ali di ospiti con le stelline", 922, 1152),
  ...
  makeProduct({
    ...
    price: "3400",
    maxPrice: "5600",
    image: img("wedding-servizio-fotografico.jpg", "Due fotografi al lavoro nel giardino di una villa nell'ora dorata", 922, 1152),
    citta: "Su richiesta",
    durata: "Giornata intera",
  ...
  makeProduct({
    ...
    price: "280",
    maxPrice: "420",
    image: img("sushi-omakase-champagne.jpg", "Vassoio in lacca nera con venti nigiri, bottiglia di Champagne in ghiaccio e due calici", 922, 1152),
    citta: "Milano",
  ...
  makeProduct({
    ...
    price: "190",
    maxPrice: "310",
    image: img("sushi-sashimi-franciacorta.jpg", "Sashimi di tonno, ricciola e capasanta su piatto scuro con wasabi fresco", 922, 1152),
    citta: "Milano",
    durata: "Consegna 19:30 – 22:00",
    partner: "Ristorante verificato",
  ...
  makeProduct({
    ...
    price: "780",
    maxPrice: "1100",
    image: img("sushi-party-magnum.jpg", "Tavolo apparecchiato per sei con vassoi di sushi e una magnum di Champagne in ghiaccio", 922, 1152),
    citta: "Milano · Monza",
  ...
  makeProduct({
    ...
    price: "1200",
    maxPrice: "1800",
    image: img("sushi-itamae-domicilio.jpg", "Itamae in giacca bianca che affetta il pesce all'isola di una cucina privata", 922, 1152),
    citta: "Milano",
    durata: "3 ore",
